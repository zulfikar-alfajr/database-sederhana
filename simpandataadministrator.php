...
$simpan  = "INSERT into administrator (tgl,nama, username, password) VALUES ('$tgl','$nama','$username','$password')";

 $result  = mysqli_query($conn, $simpan);
if($result){ //jika simpan berhasil maka muncul pesan dan menuju ke halaman utama
        echo "<script>alert('Data Berhasil disimpan, mohon di catat !!!');document.location='utamaadmin.php?page=dataregister'</script>";
